...
if (isset($config->db_host_statusreport) && isset($config->db_user_statusreport) && isset($config->db_name_statusreport) ) {
	$config->db_host = $config->db_host_statusreport;
	$config->db_port = $config->db_port_statusreport;
	$config->db_user = $config->db_user_statusreport;
	$config->db_pass = $config->db_pass_statusreport;
	$config->db_name = $config->db_name_statusreport;
}
