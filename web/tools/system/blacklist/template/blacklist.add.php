...
<body bgcolor="#e9ecef">
	<center>
		<form name="frmglobal" action="<?=$page_name?>?action=add_verify" method="post">
			<table width="50%" cellspacing="2" cellpadding="2" border="0">
				<tr align="center">
					<td colspan="2" height="10" class="blacklistTitle">Add a global entry</td>
				</tr>
				...
				<tr height="10">
					...
					<td class="searchRecord" align="left"><input name="description" class="searchInput" type="text"></td>
				</tr>
