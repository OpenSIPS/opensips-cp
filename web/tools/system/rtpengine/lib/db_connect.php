...
global $config;
if (isset($config->db_host_rtpengine) && isset($config->db_user_rtpengine) && isset($config->db_name_rtpengine) ) {
	$config->db_host = $config->db_host_rtpengine;
	$config->db_port = $config->db_port_rtpengine;
	$config->db_user = $config->db_user_rtpengine;
	$config->db_pass = $config->db_pass_rtpengine;
