...
<table width="465" cellspacing="2" cellpadding="2" border="0">
 <tr align="center">
  <td colspan="2" class="mainTitle">Edit Rule #<?=$_GET['id']?></td>
 </tr>
<?php
 if (isset($form_error)) {
...
?>
 <tr>
  ...
  <td class="dataRecord">
    <input type="text" name="groupid" id="groupid" value="<?=$resultset[0]['groupid']?>" maxlength="64" style="width:420px!important" readonly class="dataInput">
 ...
 <tr>
  ...
  <div id="div_time_recurrence" style="display:<?php if ($resultset[0]['timerec']=="") echo("none"); else echo("block") ?>">
   ...
   <div id="div_duration" style="display:none">
    ...
    <select name="frequency" class="dataSelect" id="frequency" style="width:150px!important" onChange="frequencyChange()">
 ...
 <tr>
  <td  class="dataRecord">Destination's List</td>
   <td class="dataRecord">
     <input type="text"   name="gwlist" id="gwlist" value="<?=$resultset[0]['gwlist']?>" style="width:393px!important" maxlength="<?=(isset($config->gwlist_size)?$config->gwlist_size:255)?>" readonly class="dataInput">
     <input type="button" name="clear_gwlist" value="Clear Last" class="formButton" style="width:120px;" onclick="clearObject('gwlist')"><br>
   </td>
  </tr>
  <td/>
  <td class="dataRecord">
