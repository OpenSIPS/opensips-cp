...
<?
/*
* $Id: dispatcher.add.php 55 2009-06-03 13:45:11Z iulia_bublea $
...
<table width="400" cellspacing="2" cellpadding="2" border="0">
 <tr align="center">
  <td colspan="2" class="dispatcherTitle">New Dispatcher</td>
 </tr>
<?php
?>
 <tr>
  <td class="dataRecord"><b>Setid:</b></td>
  <td class="dataRecord" width="275"><input type="text" name="setid" 
  value="<?=$setid?>"maxlength="128" class="dataInput"></td>
  </tr>

 <tr>
  <td class="dataRecord"><b>Destination:</b></td>
  <td class="dataRecord" width="275"><input type="text" name="destination" 
  value="<?=$destination?>" maxlength="128" class="dataInput"></td>
 </tr>
 
<tr>
  <td class="dataRecord"><b>Flags:</b></td>
  <td class="dataRecord" width="275"><input type="text" name="flags" 
  value="<?=$flags?>" maxlength="128" class="dataInput"></td>
 </tr>
