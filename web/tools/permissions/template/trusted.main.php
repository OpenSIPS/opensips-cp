...
-->
<div align="right">
 <?php if (!$_read_only) echo('<button type="button" class="Button" onClick="window.open(\'trusted_apply_changes.php\',\'apply\',\'width=300,height=100\')">Apply Changes to Server</button><br>') ?>
</div>
<br>
...
<?php
$sql_search="";
$search_src=$_SESSION['trusted_src'];
$search_proto=$_SESSION['trusted_proto'];
if($search_src!="") $sql_search.=" and src_ip like '%".$search_src."%'";
...
<table width="50%" cellspacing="2" cellpadding="2" border="0">
 <tr align="center">
  ...
  <tr>
  <td class="searchRecord" align="center">Source IP :</td>
  <td class="searchRecord" width="200"><input type="text" name="trusted_src" 
  value="<?=$search_src?>" maxlength="16" class="searchInput"></td>
 </tr>
  <tr>
  <td class="searchRecord" align="center">Protocol:</td>
  <td class="searchRecord" width="200"><input type="text" name="trusted_proto" 
...
if(!$_SESSION['read_only']){
	echo('<tr height="10">
  <td colspan="2" class="searchRecord" align="center">
	  <input type="submit" class="formButton" name="delete" value="Delete Trusted" onclick="return confirmDeletePermission()">
 </tr>');
}
?>
 <tr height="10">
...
<table width="95%" cellspacing="2" cellpadding="2" border="0">
 <tr align="center">
  ...
  <td class="permissionsTitle">Source IP</td>
  <td class="permissionsTitle">Protocol</td>
  <td class="permissionsTitle">From pattern</td>
  <td class="permissionsTitle">Tag</td>
  <?
  if(!$_SESSION['read_only']){
