...
d3.csv("../../../common/get_data.php?stat=".concat(arg1).concat("&full_stat=").concat(arg2).concat("&box=").concat(arg3).concat("&normal=").concat(arg4),
  ...
  const tooltipCircle = svg
    ...
    function updateGr() {
      if( refresh == 1) {
        d3.csv("../../../common/get_data.php?stat=".concat(arg1).concat("&full_stat=").concat(arg2).concat("&box=").concat(arg3).concat("&zoomOut=").concat(zoomTrigger).concat("&normal=").concat(arg4),
