...
# Attention : advanced options !!
 ...
 $module_id = "sockets_mgm";
 $custom_config[$module_id] = array ();

 // a custom global name for the tool
 $custom_config[$module_id]['custom_name'] = "Sockets Management";

 include("../../../../web/common/forms.php");
 global $re_ip_port;
 global $re_socket;
...
$custom_config[$module_id][0]['custom_table'] = "sockets";
...
*/
 ...
 $custom_config[$module_id][0]['custom_table_column_defs'] = array (
			...
			"socket" 	=> 	array (
					...
					"type"				=> "text",
					"key"				=> NULL,
					"tip"				=> "The socket defined in the <proto>:<ip>:<port> format",
			...
			"advertised" 	=> 	array (
					...
					"type"				=> "text",
					"key"				=> NULL,
					"tip"				=> "The address advertised for this socket, defined as <ip>:<port> format",
					"validation_regex" 	=> "^([a-zA-Z1-9][a-zA-Z0-9\\._]+)(:[0-9]+)?$",
					"show_in_add_form" 	=> true,
					"show_in_edit_form"	=> true,
					"searchable" 		=> true,
					"is_optional"		=> "y",
			...
			"tag" 	=> 	array (
					...
					"type"				=> "text",
					"key"				=> NULL,
					"tip"				=> "Optional tag that can be assigned to this socket",
			...
			"flags" 	=> 	array (
					...
					"type"				=> "checklist",
					"key"				=> NULL,
					"tip"				=> "Flags assigned to the socket",
					"show_in_add_form" 	=> true,
					"show_in_edit_form"	=> true,
					"searchable" 		=> true,
					"is_optional"		=> "y",
					"checklist_separator"		=> ",",
					"checklist_display_col"		=> true,
					"checklist_default_values"	=> array("anycast"=>"Anycast","frag"=>"Allow Fragments","reuse_port"=>"Reuse Port"),
			),
			"tos"	=> 	array (
					"header" 			=> "Type of Service",
					"type"				=> "combo",
					"key"				=> NULL,
					"tip"				=> "Type of Service used for this socket",
					"validation_regex" 	=> NULL,
					"show_in_add_form" 	=> true,
					"show_in_edit_form"	=> true,
					"searchable" 		=> true,
					"is_optional"		=> "y",
					"combo_default_values" => array("IPTOS_LOWDELAY"=>"Low Delay","IPTOS_THROUGHPUT"=>"Throughpyt","IPTOS_RELIABILITY"=>"Reliability", "IPTOS_MINCOST"=>"Minimum Cost", "IPTOS_LOWCOST"=>"Low Cost")
			),
			/*
			"remote_addr" 	=> 	array (
