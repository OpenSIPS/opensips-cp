...
# Attention : advanced options !!
 ...
 $module_id = "dialplan_siprec";
 $custom_config[$module_id] = array ();

 // a custom global name for the tool
 $custom_config[$module_id]['custom_name'] = "Recording Filtering";
...
$custom_config[$module_id][0]['custom_table'] = "dialplan_siprec";
...
$custom_config[$module_id][0]['custom_table_column_defs'] = array (
	...
	"dpid" 	=> 	array (
		...
		"searchable" 			=> true,
		"combo_default_values"		=> array("2"=>"INBOUND","3"=>"OUTBOUND","4"=>"ANY"),
		"combo_table"			=> NULL,
	...
	"match_exp"	=> 	array (
		...
		"key"				=> NULL,
		"is_optional"			=> "n",
		"tip"				=> "The username you enable SIP recording for; can be a regular expression",
		"validation_regex" 		=> "^.*$",
		"show_in_add_form" 		=> true,
		"show_in_edit_form"		=> true,
		"searchable" 			=> true,
	...
	"disabled" 	=> 	array (
		...
		"validation_regex" 		=> "^[0-9]+$",
		"visible"			=> false,
		"tip"				=> "Indicates whether the rule is enabled (ON) or disabled (OFF).",
		"combo_default_values"		=> array("0"=>"ON","2"=>"OFF"),
		"combo_table"			=> NULL,
		"combo_value_col"		=> NULL,
		"combo_display_col"		=> NULL,
		"default_value"			=> "0",
 ...
 $custom_config[$module_id][0]['custom_mi_command'] = "dp_reload siprec";
