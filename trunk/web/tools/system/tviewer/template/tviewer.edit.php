...
<?php
/*
 * $Id: dispatcher.edit.php 133 2009-10-29 18:05:56Z iulia_bublea $
 ...
 */
 ...
 if (isset($form_error)) {
	...
	$sql = "select * from ".$table." where ".$config->custom_table_primary_key."='".$id."'";
...
<table width="400" cellspacing="2" cellpadding="2" border="0">
 <tr align="center">
  <td colspan="2" class="dispatcherTitle">Edit Record</td>
 </tr>
<?php
...
?>
 <tr>
  ...
  <td class="dataRecord" width="275"><input type="text" name="<?php echo $value; ?>" value="<?=$resultset[0][$value]?>" maxlength="128" class="dataInput"></td>
  </tr>
