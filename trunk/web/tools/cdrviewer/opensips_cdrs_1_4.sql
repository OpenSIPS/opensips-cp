...
BEGIN
  ...
  DECLARE inv_cursor CURSOR FOR SELECT src_leg,  dst_leg, time, callid, from_tag, to_tag, caller_id, callee_id, leg_type, leg_transition, in_gw, leg_status FROM opensips_1_4.acc where method='INVITE' and cdr_id='0';
