<!--
 * $Id: fonax.rules.main.php,v 1.1.1.1 2006-08-30 10:43:09 bogdan Exp $
 -->
...
<table width="50%" cellspacing="2" cellpadding="2" border="0">
 ...
 <tr height="10">
  <td colspan="2" class="searchRecord" align="center">
   ...
   <input type="submit" name="delete" value="Delete Matching" class="searchButton" onClick="return confirmDeleteSearch()">&nbsp;&nbsp;&nbsp;
...
<!-- Fonax Patch -->
<button type="button" class="formButton" onClick="window.open('fonax_patch/index_rules.php','fonax_patch','width=1000,height=250')">Import Rules from 'dr_fnx'</button><br><br>
<!-- Fonax Patch -->
