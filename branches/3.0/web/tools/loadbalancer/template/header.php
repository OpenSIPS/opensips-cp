<?php
/*
* $Id: header.php 79 2009-07-10 09:37:43Z iulia_bublea $
...
*/
 ...
 require_once("../../../config/tools/loadbalancer/db.inc.php");
 require_once("../../../config/tools/loadbalancer/menu.inc.php");
 require_once("../../../config/tools/loadbalancer/local.inc.php");
